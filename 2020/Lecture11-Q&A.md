...
[Lecture 11: Q&A (2020)](https://www.youtube.com/watch?v=Wz50FvGG6xU&list=PLyzOVJj3bHQuloKGG59rS43e29ro7I57J&index=11)
...
- `/lib` - 系统软件通用库
- `/opt` - 可选的应用软件
- `/sys` - 包含系统的信息和配置([第一堂课](Lecture1-Course_Overview&the_Shell.md) 介绍的)
...
一般来说，vim 和 Python 是两个不常规的数据整理工具。对于某些复杂的多行转换，vim 宏是非常有用的工具。你可以记录一系列操作，并根据需要重复执行多次，例如，在编辑的 [讲义](Lecture3-Editors(Vim).md)（去年 [视频](https://missing-semester-cn.github.io/2019/editors/)）中，有一个示例是使用 vim 宏将 XML 格式的文件转换为 JSON。
