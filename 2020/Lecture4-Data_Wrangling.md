...
如果您使用的是 MacOS：注意这个命令并不能配合 MacOS 系统默认的 BSD `paste` 使用。参考 [课程概览与 shell](Lecture1-Course_Overview&the_Shell.md) 的习题内容获取更多相关信息。
...
[习题解答](solutions/Lecture4-Solution.md)
